      ...
      <div className="relative aspect-square w-full overflow-hidden bg-slate-50 dark:bg-slate-950">
        ...
        <div className="absolute top-3 left-3 z-10 flex flex-col gap-1.5 ">
          {discountPercent > 0 && (
            <Badge
              variant="destructive"
              className="bg-rose-500 text-white border-transparent px-2.5 py-1 text-xs font-semibold shadow-sm dark:bg-rose-500 dark:text-white"
            >
              -{discountPercent}%
            </Badge>
          )}
          {isFeatured && (
            <Badge className="bg-indigo-600 hover:bg-indigo-700 text-white px-2.5 py-1 text-xs font-semibold shadow-sm dark:bg-indigo-500 dark:text-white">
