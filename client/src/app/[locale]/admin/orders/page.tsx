...
export default function AdminOrdersPage(): React.JSX.Element {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-card dark:bg-card p-5 rounded-2xl border border-border dark:border-border shadow-sm space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="space-y-1.5">
            ...
            <select
              ...
              className="w-full h-11 rounded-xl border border-border bg-card px-3.5 text-sm text-foreground focus:border-indigo-500 focus:outline-none dark:border-border/60 dark:bg-card dark:text-foreground"
            >
        ...
        <div className="flex flex-col sm:flex-row items-end sm:items-center justify-between gap-4 pt-2 border-t border-border dark:border-border/40">
          <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
            <div className="flex items-center gap-2">
              <Calendar className="h-4 w-4 text-muted-foreground" />
              <span className="text-xs font-bold text-muted-foreground dark:text-muted-foreground uppercase tracking-wider">Tarix:</span>
            </div>
            <div className="flex items-center gap-2">
              <Input
                type="date"
      ...
      <div className="bg-card dark:bg-card border border-border dark:border-border rounded-2xl shadow-sm overflow-hidden">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center p-16 space-y-4 text-center">
            ...
            <h4 className="font-extrabold text-foreground dark:text-foreground">{t('no_orders')}</h4>
              ...
              <Table>
                ...
                <TableBody>
                  {ordersData.data.map((order) => (
                    <TableRow key={order.id} className="group hover:bg-muted/20 dark:hover:bg-background/5">
                      <TableCell className="px-6 py-4 font-mono font-bold text-foreground dark:text-foreground">
                        {order.orderNumber}
                      </TableCell>
                      ...
                      <TableCell className="px-6 py-4 text-right">
                        <Button
                          ...
                          className="px-3 py-1.5 text-xs font-bold rounded-xl bg-muted hover:bg-indigo-50 dark:bg-background dark:hover:bg-indigo-950/20 text-foreground hover:text-indigo-600 dark:text-muted-foreground transition-colors"
                        >
      ...
      >
        {isDetailLoading ? (
          ...
          <div className="space-y-6 pt-2 pb-4 overflow-y-auto max-h-[80vh] px-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 bg-muted dark:bg-background/40 p-4 rounded-2xl border border-border dark:border-border">
              <div className="flex items-center gap-3">
                <div className="p-2.5 bg-indigo-50 dark:bg-indigo-950/40 text-indigo-600 rounded-xl">
                  <User className="h-5 w-5" />
                </div>
                <div>
                  <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">{t('customer')}</p>
                  <p className="text-sm font-bold text-foreground dark:text-foreground truncate max-w-[180px]">{orderDetail.user.name}</p>
                  <p className="text-xs text-muted-foreground truncate max-w-[180px]">{orderDetail.user.email}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">{t('total')}</p>
                  <p className="text-sm font-extrabold text-foreground dark:text-foreground">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-3">
                <h4 className="flex items-center gap-2 text-sm font-black uppercase text-foreground dark:text-foreground border-b border-border dark:border-border pb-2">
                  <MapPin className="h-4 w-4 text-indigo-500" />
                  {t('shipping_address')}
                </h4>
                <div className="bg-muted/50 dark:bg-background/10 p-4 rounded-2xl border border-border dark:border-border space-y-1.5 text-sm text-foreground dark:text-muted-foreground">
                  <p className="font-bold text-foreground dark:text-foreground">{orderDetail.address.fullName}</p>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-muted/50 dark:bg-background/10 p-4 rounded-2xl border border-border dark:border-border space-y-2.5 text-sm">
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">{t('payment_method')}:</span>
                    <span className="font-bold text-foreground dark:text-foreground capitalize">
                  ...
                  <div className="flex justify-between border-t border-border dark:border-border/60 pt-2 flex-col gap-1">
                    <span className="text-muted-foreground">{t('notes')}:</span>
                    <span className="text-foreground dark:text-muted-foreground italic">
            ...
            <div className="space-y-3">
              ...
              <div className="border border-border dark:border-border rounded-2xl overflow-hidden">
                <Table>
                  <TableHeader>
                    <TableRow className="bg-muted/30 dark:bg-background/10">
                    ...
                    {orderDetail.items.map((item) => (
                      <TableRow key={item.id}>
                        <TableCell className="px-4 py-3">
                          <div className="flex items-center gap-3">
                            <div className="relative h-10 w-10 rounded-lg overflow-hidden border border-border dark:border-border shrink-0 bg-muted dark:bg-background">
                              {item.product?.image ? (
                                <Image
                                ...
                                <HelpCircle className="h-5 w-5 m-2.5 text-muted-foreground" />
                              )}
                            </div>
                            <div>
                              <span className="text-sm font-semibold text-foreground dark:text-foreground line-clamp-1">
                                {item.productName}
                              </span>
                              <span className="text-[10px] font-mono text-muted-foreground block tracking-tight">
                                SKU: {item.productSku}
                              </span>
                            </div>
                          </div>
              ...
              <div className="flex justify-end pt-2">
                <div className="w-full sm:w-80 bg-muted/60 dark:bg-background/20 border border-border dark:border-border p-4 rounded-2xl space-y-2.5 text-sm">
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">{t('subtotal')}:</span>
                    <span className="font-bold text-foreground dark:text-foreground">{Number(orderDetail.subtotal).toFixed(2)} AZN</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between border-t border-border dark:border-border/80 pt-2.5 text-base font-extrabold text-foreground dark:text-foreground">
                    <span>{t('total')}:</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 border-t border-border dark:border-border pt-6">
              {/* Status Timeline History */}
              <div className="space-y-4">
                <h4 className="flex items-center gap-2 text-sm font-black uppercase text-foreground dark:text-foreground">
                  <Clock className="h-4 w-4 text-indigo-500" />
                  {t('history')}
                </h4>
                <div className="relative pl-6 space-y-5 border-l-2 border-border dark:border-border/60 ml-2 pt-1">
                  {orderDetail.statusHistory.map((hist, idx) => (
                    <div key={idx} className="relative">
                      {/* Circle indicator */}
                      <span className="absolute -left-[31px] top-0.5 flex h-4.5 w-4.5 items-center justify-center rounded-full border-2 border-white dark:border-border bg-indigo-500 text-white">
                      ...
                      <div>
                        ...
                        {hist.note && (
                          <p className="text-xs text-muted-foreground dark:text-muted-foreground mt-1 italic leading-relaxed">
                            {hist.note}
                          </p>
                        )}
                      </div>
              ...
              {/* Status Update Form */}
              <div className="space-y-4 bg-muted/50 dark:bg-background/20 p-5 border border-border dark:border-border rounded-2xl">
                <h4 className="flex items-center gap-2 text-sm font-black uppercase text-foreground dark:text-foreground">
                ...
                <form onSubmit={handleStatusSubmit} className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <select
                      ...
                      required
                      className="w-full h-10 rounded-xl border border-border bg-card px-3.5 text-xs text-foreground focus:border-indigo-500 focus:outline-none dark:border-border/60 dark:bg-card dark:text-foreground"
                    >
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full rounded-xl border border-border bg-card px-3.5 py-2 text-xs text-foreground focus:border-indigo-500 focus:outline-none dark:border-border/60 dark:bg-card dark:text-foreground resize-none"
                    />
                  </div>
