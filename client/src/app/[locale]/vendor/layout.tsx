// src/app/[locale]/vendor/layout.tsx
// Vendor dashboard wrapper: wraps vendor routes with role-based auth guard and sidebar navigation
...
import { Store, Menu, X, LogOut, Bell } from 'lucide-react';
...
export default function VendorLayout({ children }: VendorLayoutProps): React.JSX.Element {
        ...
        >
          <div className="space-y-6">
            <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
              <div className="flex items-center gap-2">
                <Store className="h-5 w-5 text-purple-650" />
                <span className="font-extrabold text-slate-900 dark:text-white">Satıcı Paneli</span>
              </div>
            ...
            <nav className="space-y-1">
              {vendorNavItems.map((item) => (
                <Link
                  ...
                  onClick={() => setMobileMenuOpen(false)}
                  className="flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-semibold text-slate-700 hover:bg-slate-50 dark:text-slate-355 dark:hover:bg-slate-900 transition-all duration-200"
                >
          ...
          <div className="pt-4 border-t border-slate-100 dark:border-slate-800">
            <button
              ...
              className="w-full flex items-center gap-3 rounded-xl px-4 py-2.5 text-sm font-semibold text-rose-650 hover:bg-rose-50 dark:text-rose-450 dark:hover:bg-rose-950/20 focus:outline-none"
            >
        ...
        <div className="flex-1 md:pl-64 flex flex-col min-w-0">
          ...
          <header className="sticky top-0 z-30 h-16 border-b border-slate-200/80 bg-white/80 backdrop-blur-md dark:border-slate-800/80 dark:bg-slate-950/80 flex items-center justify-between px-4 sm:px-6">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                <span className="hidden sm:inline-block px-2.5 py-1 rounded-lg bg-purple-50 dark:bg-purple-950/50 text-purple-650 dark:text-purple-400 font-extrabold text-xs">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2 border-l border-slate-200 dark:border-slate-800 pl-3">
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-tr from-purple-500 to-pink-500 text-white font-bold text-xs">
